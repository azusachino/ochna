...
fn write_agent_pointer(
    ...
    let content = format!(
        "<!-- generated by ochna init - do not edit -->\n\
         \n\
         # ochna index\n\
         \n\
         Indexed SHA: {}\n\
         Branch: {}\n\
         Working tree at index time: {}\n\
         Indexed at: {}\n\
         \n\
         This repo is indexed by ochna. Run `ochna howto` to learn the query flow, and `ochna status` to check freshness.\n",
        git_sha.unwrap_or("N/A"),
        git_branch.unwrap_or("N/A"),
        git_status.unwrap_or("N/A"),
        indexed_at
    );
    fs::write(ochna_dir.join("AGENT.md"), content)
}
